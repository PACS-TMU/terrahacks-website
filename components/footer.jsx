            ...
            <footer className="bg-[#0B0507] text-white py-12">
                <div className="main flex flex-col items-center justify-center space-y-6">
                    ...
                    <div className="flex flex-col lg:flex-row items-center justify-center space-y-4 lg:space-x-12">
                        <a aria-label='Link to MLH Code of Conduct' rel='noopener noreferrer' href="https://github.com/MLH/mlh-policies/blob/main/code-of-conduct.md" target="_blank" className="md:text-lg lg:text-xl xl:text-2xl hover:text-gray-300 ease-in-out duration-300 underline">MLH Code of Conduct</a>
                        <a aria-label='Link to Sponsorship Package' rel='noopener noreferrer' href="https://drive.google.com/file/d/1yZpr0HeziOeStxhHxH8ggwjn_QF1lFSw/view?usp=sharing" target="_blank" className="md:text-lg lg:text-xl xl:text-2xl hover:text-gray-300 ease-in-out duration-300 underline ">Become a Sponsor!</a>
                    </div>
                    <p className="md:text-lg lg:text-xl xl:text-2xl font-medium py-4 lg:py-8">Copyright © 2025 TerraHacks</p>
                </div>
            </footer>
        </>
    );
